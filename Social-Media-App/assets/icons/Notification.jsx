...
const Notification = (props) => {
  // Nếu active, Facebook thường ẩn đường stroke để icon nhìn mượt hơn
  ...
  return (
    ...
    >
      <Path
        ...
        strokeLinecap="round"
        fill={isFilled ? props.color : "none"} // Đổ màu vào quả chuông nhỏ phía dưới
      />
      <Path
        ...
        stroke={isFilled ? "none" : props.color} // Khi fill thì bỏ stroke cho giống FB
        strokeWidth={props.strokeWidth || 1.5}
        strokeLinejoin="round"
        fill={isFilled ? props.color : "none"} // Đổ màu đặc khi active
      />
    </Svg>
  );
};
